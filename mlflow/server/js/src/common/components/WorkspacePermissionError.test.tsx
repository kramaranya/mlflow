...
describe('WorkspacePermissionError', () => {
  ...
  it('displays the workspace name in the error message', () => {
    ...
    expect(screen.getByText(/You don't have access to workspace: restricted-workspace/i)).toBeInTheDocument();
  ...
  it('displays error for workspace with special characters', () => {
    ...
    expect(screen.getByText(/You don't have access to workspace: team\/special-chars!/i)).toBeInTheDocument();
  });
});
